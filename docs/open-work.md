...
- Mayor mandate: the active plan survives autonomous continuation and player messages. The chat plan strip shows the plan (empty state and after `set_plan`), not a transcript line.
