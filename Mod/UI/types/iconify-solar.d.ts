...
declare module "@iconify-icons/solar/plain-linear" {
  import type { IconifyIcon } from "@iconify/react";
  const icon: IconifyIcon;
  export default icon;
}

declare module "@iconify-icons/solar/stop-circle-linear" {
  import type { IconifyIcon } from "@iconify/react";
  const icon: IconifyIcon;
  export default icon;
}

declare module "@iconify-icons/solar/alt-arrow-down-linear" {
  import type { IconifyIcon } from "@iconify/react";
  const icon: IconifyIcon;
  export default icon;
}
